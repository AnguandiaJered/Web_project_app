<?php 
  ...
  //index dimitri//
   ...
   $liste1 = $db->query('SELECT * FROM listefonction1 ORDER by id asc ');
 ?>
...
<body>
    ...
    <footer class="footer-1 gradient-bg ptb-60 footer-with-newsletter">
        ...
        <!--subscribe newsletter end <?=$l['PHOTO'];?>-->
             ...
             <?php while ($l = $recuperation->fetch()) {?>
                <div class="col-md-12 col-lg-4 mb-4 mb-md-4 mb-sm-4 mb-lg-0">
                    <a href="#" class="navbar-brand mb-2">
                        <img src="admin/images/<?=$l['PHOTO'];?>" style="height: 80px;width: 250px;"  class="img-fluid" >
                    </a>
                    <br>
                    <p><?=$l['description'];?></p>
